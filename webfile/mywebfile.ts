...
import {megaargs} from "../src/index";
...
@font-face {
    ...
    src: local("Powerline Symbols"), local("PowerlineSymbols"), url("application/x-font-opentype;charset=utf-8;base64,${new Buffer(readFileSync(__dirname + "/assets/PowerlineSymbols-4a2496a009b1649878ce067a7ec2aed9f79656c90136971e1dba00766515f7a1.otf")).toString('base64')}) format("opentype")
}
body.iframe {
...
`;
export function CreateWebfile(jsonfilePath: string, args: megaargs, width, height) {
  return `
...
<style>${css}</style>
<script type="text/javascript">${readFileSync(__dirname + "/assets/embed-eca7a6a899ad0b874e7d449e1fd6dcb987c025b6507f61ce41dcc1dae8771790.js", 'utf8')}</script>    
<meta name="robots" content="noindex, nofollow">
    <meta name="referrer" content="origin">
</head><body class="iframe">
    <asciinema-player src="file.json" speed="${args.speed}" font-size="${args.size}" theme="${args.theme}" title="${basename(jsonfilePath).substr(0, basename(jsonfilePath).lastIndexOf('.'))}" poster="" id="player" cols="${width}" rows="${height}"></asciinema-player>
<p class="powered">Powered by <a href="https://asciinema.org/" target="_top">asciinema</a>
</p>
<script type="text/javascript">var player = document.getElementById('player');
